...
const { Attendance_Main_Dashboard, viewAttendance, viewEmployeeAttendanceRecords,
     viewAttendanceStats
  } =
...
attendance.get('/employee-attendance/:employeeId', viewEmployeeAttendanceRecords);
