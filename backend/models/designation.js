...
Designation.createNewDesignation = async (name, departmentID) => {
    ...
    try {
        ...
        console.log(`Designation '${name}' created and associated with department ID ${departmentID} successfully.`);
    } catch (error) {
        // Rollback the transaction on error
        await transaction.rollback();
        console.error('Error creating designation and associating it with department:', error);
        throw error;
    }
};
