  ...
  try {
    ...
    if (!leaveDetails) {
      return sendResponse(
        ...
        null,
        'Leave details not found for this Leave'
      );
    }
    return sendResponse(
      res,
...
exports.getAllEmployeesLeaveDetails = async (req, res) => {
  try {
    ...
    return sendResponse(
      ...
      httpStatus.OK,
      leaveDetails,
      'All leave details retrieved successfully'
    );
  } catch (error) {
  ...
  try {
    ...
    if (!stats) {
      return sendResponse(
        ...
        httpStatus.NOT_FOUND,
        null,
        'Leave statistics not found for the given employee'
      );
    }
    ...
    return sendResponse(
      ...
      httpStatus.OK,
      stats,
      'Employee leave statistics retrieved successfully'
    );
  } catch (error) {
    ...
    return sendResponse(
      ...
      httpStatus.INTERNAL_SERVER_ERROR,
      null,
      'Error fetching leave statistics',
      error.message
    );
  }
};
